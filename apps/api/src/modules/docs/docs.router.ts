...
function buildOpenApiSpec() {
  ...
  return {
    ...
    paths: {
      ...
      '/api/v1/campaigns/{id}': {
        get: { summary: 'Campaign detail + stageCounts + recentCalls' },
        patch: { summary: 'Edit campaign (name, verticals, personas, titles, pacing, status)' },
        delete: { summary: 'Soft-delete (archive) a campaign' },
      },
      ...
      '/api/v1/leads/{id}': {
        get: { summary: 'Lead detail + calls + emails' },
        patch: { summary: 'Edit lead + nested contact/company fields' },
        delete: { summary: 'Soft-delete a lead' },
      },
